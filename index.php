  ...
  <div class="container">
          ...
          <div class="card-body">
            ...
            <form class="form-signin" method="post" action="log_val.php">
              <div class="form-label-group">
                <br>
                <input type="text" id="inputName" class="form-control" name="phone" placeholder="Phone Number" required autofocus>
                <br>
              </div>
              <div class="form-label-group">
    ...
    <footer>
      <div class="container text-center">
        <p>Copyright &copy; Project Database System 2022</p>
